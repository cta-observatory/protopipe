#!/usr/bin/env python3
"""
Class to write data from an event stream
"""
...
__all__ = ["DataWriter", "DL1_DATA_MODEL_VERSION", "write_reference_metadata_headers"]
...
class DataWriter(Component):
    ...
    .. code-block:: python
        ...
        with DataWriter(parent=self) as write:
            for event in source:
                calibrate(event)
