    ...
    def initialise_clean_opt(self):
        ...
        if self.mode in 'tail':
            ...
            for type in opt['thresholds']:
                ...
                self.cleaners[cam_id] = lambda img, geom, opt: \
                    tailcuts_clean(image=img, geom=geom, **opt)
            ...
            for cam_id in opt['options']:
                ...
                self.cleaners[cam_id] = lambda img, opt: \
                    WaveletTransform().clean_image(input_image=img, **opt)
