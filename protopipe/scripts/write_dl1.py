...
def main():
    ...
    parser.add_argument('--estimate_energy', type=str2bool, default=False,
                        help="Make estimation of energy")
    parser.add_argument('--regressor_dir', type=str, default='./',
    ...
    for i, filename in enumerate(filenamelist):
        ...
        for (event, n_pixel_dict, hillas_dict, n_tels,
            ...
            for idx, tel_id in enumerate(hillas_dict.keys()):
                ...
                feature_events[cam_id]["impact_dist"] = impact_dict[tel_id].to('m').value
                ...
                feature_events[cam_id]["mc_h_first_int"] = event.mc.h_first_int.to('m').value
